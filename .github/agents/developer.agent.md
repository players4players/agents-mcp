---
name: Developer
description: Executor autonomo de issues do repositorio <<OWNER>>/agents-mcp, com fonte canonica centralizada no agents-mcp.
...
1. `https://github.com/<<OWNER>>/agents-mcp/blob/master/agents/roles/developer/agent.md`
...
4. `https://github.com/<<OWNER>>/agents-mcp/blob/master/agents/skills/by-role/developer/README.md`
