...
2. **Associe-a ao projeto** `https://github.com/orgs/players4players/projects/1/views/1` (ProjectV2 da org, number `1`).
...
- Issues do GitHub na org `players4players` (ou escopo restrito pelo prompt).
...
2. Se o prompt **nao** definir issue/repositorio:
   - busque issues em **todos** os repositorios da org `players4players` (preferencialmente por label/estado);
...
- issues `open` na org `players4players`;
